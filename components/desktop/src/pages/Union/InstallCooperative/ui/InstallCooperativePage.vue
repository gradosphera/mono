          ...
          .completion-section.q-pa-xl
            ...
            .completion-details.q-mt-xl
              .detail-text.text-body2.q-mb-lg
                | Всем членам совета отправлены приглашения на электронные почты со ссылками для генерации цифровых подписей. Перейдите по своей ссылке из письма, получите ключ председателя, после чего, используйте его для входа в свою систему.
