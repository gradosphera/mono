...
BaseCard.capital-doc-params(title='Параметры документов ЦПП')
  p.t-body-sm.capital-doc-params__intro
    ...
    | Пустые поля подсвечиваются оранжевым — подсвеченные области можно редактировать inline.

  BaseBanner(v-if='savedHash' type='success' class='q-mb-md')
    | Параметры сохранены. Хеш: {{ savedHash }}
  ...
  q-tab-panels(v-model='activeTab' animated class='capital-doc-params__panels')
    q-tab-panel(
      ...
      p.t-caption.text-grey-7.q-mb-md {{ section.hint }}
