  ...
  q-table(
    ...
    template(#body='props')
      q-tr(
        ...
        ) {{ props.row.title }} Теперь при нажатии на кнопку "Создать компонент" форма будет появляться, а меню автоматически скроется! 🎯 Теперь при нажатии на кнопку "Создать компонент" форма будет появляться, а меню автоматически скроется! 🎯
