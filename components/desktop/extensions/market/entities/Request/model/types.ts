...
export interface IRequestData
  ...
  created_at: Date;
  expired_at: Date;
  /** Остаток единиц (с сервера/парсера) */
  remain_units?: string | number;
  /** Заблокированные единицы */
  blocked_units?: string | number;
  /** Доставленные единицы */
  delivered_units?: string | number;
}
