    ...
    .card-front.front
      .card-content
        .widget-header
          ...
          .widget-title Сетевой трафик (NET)
        ...
        ColorCard(color='green')
          | NET используется для передачи данных документов между узлами блокчейна.
