...
export const translations = {
  ru: {
    ...
    force_majeure_cases_list: 'Форс-мажорными являются также все случаи которые являются форс мажорными при гражданском обороте в том числе: повреждение, порча имущества, в т. ч. созданное и приобретенное Обществом в рамках настоящего Договора, через пожар, затопление, кражу, гражданские конфликты, военные действия, комендантский час, объявленный карантин, стихийные бедствия и др.',
    ...
    interaction_remotely: 'Взаимодействие Пайщика и Общества в рамках настоящего Договора, могут проводиться дистанционно в электронном виде, в том числе и через ЛК Пайщика в информационной системе Общества на сайте {{ vars.website }}.',
