...
<tr>
<td style="font-weight: bold;">{% trans 'property_name' %}</td>
<td>{% trans 'share_contribution' %} "{{ project_name }}" {% trans 'component' %} "{{ component_name }}"</td>
</tr>
<tr>
...
<td>{% trans 'description_text' %} {{ percent_of_result }}% {% trans 'in_copyright_object_short' %}, {% trans 'namely' %} c9s://{{ result_hash }}</td>
</tr>
<tr>
...
<td>{% trans 'other_characteristics_text' %} №{{ result_hash }}.</td>
</tr>
</table>

<table class="property-table" border="1" style="width: 100%; border-collapse: collapse;">
<tr>
<td style="font-weight: bold;">{% trans 'number_pp' %}</td>
<td style="font-weight: bold;">{% trans 'name_details' %}</td>
<td style="font-weight: bold;">{% trans 'unit' %}</td>
<td style="font-weight: bold;">{% trans 'quantity' %}</td>
<td style="font-weight: bold;">{% trans 'total_cost' %}</td>
</tr>
<tr>
<td>1</td>
<td>{% trans 'property_description' %} {{ percent_of_result }}% {% trans 'in_copyright_object_short' %}</td>
<td>{% trans 'share' %}</td>
<td>{{ percent_of_result }}%</td>
<td>{{ total_amount }}</td>
</tr>
<tr>
<td></td>
