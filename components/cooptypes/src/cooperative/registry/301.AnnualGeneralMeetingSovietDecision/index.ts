...
export const title = 'Решение совета о созыве общего собрания'
export const description = 'Форма протокола собрания совета о созыве очередного/внеочередного общего собрания'
