...
export const translations = {
  ru: {
    ...
    protocol: 'Протокол №',
    from_date: 'от',
    generation_agreement_title: 'ДОГОВОР',
...
export const exampleData = {
  ...
  coop: {
    ...
    genitive_short_name: 'ПК "ВОСХОД"',
    inn: '9728130611',
    kpp: '772801001',
    ogrn: '1247700283346',
    legal_address: '117593, г. МОСКВА, ВН.ТЕР.Г. МУНИЦИПАЛЬНЫЙ ОКРУГ ЯСЕНЕВО, ПРОЕЗД СОЛОВЬИНЫЙ, Д. 1, ПОМЕЩ. 1/1',
    contact_phone: '+7 902 895-33-75',
    contact_email: 'chairman.voskhod@gmail.com',
    bank_account: '40703810038000110117',
    correspondent_account: 'ПАО Сбербанк БИК 044525225 Корр/счет: 30101810400000000225',
    chairman: {
      first_name: 'Алексей',
      last_name: 'Муравьев',
