 ...
 */
[[eosio::action]] void soviet::createagenda(eosio::name coopname, eosio::name username, name callback_contract, name callback_action, uint64_t batch_id, document statement, std::string meta){
