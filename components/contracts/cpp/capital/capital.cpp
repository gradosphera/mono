...
// Приложения
#include "src/appendix/createappndx.cpp"
#include "src/appendix/apprvappndx.cpp"
#include "src/appendix/dclineappndx.cpp"


// Аллокация средств
#include "src/allocation/allocate.cpp"
#include "src/allocation/diallocate.cpp"
...
*/
static bool capital::is_contributor_has_appendix_in_project(eosio::name coopname, const checksum256 &project_hash, eosio::name username, eosio::name contract_name) {
