...
namespace Capital::Core {
  ...
  /**
   * @brief Функция получения баланса паевых взносов по программе благороста
   */
  ...
  /**
   * @brief Функция получения баланса паевых взносов пользователя в программе благороста
   */
