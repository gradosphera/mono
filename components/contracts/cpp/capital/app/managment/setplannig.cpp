void capital::setplannig(name coopname, name application, checksum256 assignment_hash, uint64_t plan_time, asset plan_expense, asset norma_hour_cost) {
    ...
    auto master = Capital::get_assignment_master_or_fail(coopname, assignment_hash, "Мастер задания не найден");
    ...
    auto assignment = Capital::get_assignment_or_fail(coopname, assignment_hash, "Задание не найдено");
