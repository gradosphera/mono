/**
 * Устанавливает конфигурацию кооператива.
 *
 * Обновляет глобальное состояние контракта для указанного кооператива, создавая запись,
 * если она отсутствует, либо модифицируя существующую.
 *
