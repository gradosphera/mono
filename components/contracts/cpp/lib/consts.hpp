...
static constexpr eosio::name _capital_withdraw_authorize_contribution_action = "capauthwthdc"_n;
static constexpr eosio::name _capital_withdraw_authorize_return_action = "capauthwthdr"_n;
