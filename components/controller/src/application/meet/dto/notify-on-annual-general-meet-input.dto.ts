...
import { AnnualGeneralMeetingNotificationSignedDocumentInputDTO } from '~/application/document/documents-dto/annual-general-meeting-notification-document.dto';
