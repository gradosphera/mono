...
export class ProjectPermissionsOutputDTO {
  ...
  /**
   * Создание требований (stories) у проекта — по матрице роли в проекте (мастер, автор, председатель и т.д.).
   */
  @Field(() => Boolean, {
  ...
  /**
   * Редактирование требований (stories) у проекта — по матрице роли в проекте.
   */
  @Field(() => Boolean, {
    description: 'Может ли редактировать требования к проекту',
  })
  can_edit_requirement!: boolean;

  /**
   * Удаление требований у проекта — по матрице роли в проекте.
   */
  @Field(() => Boolean, {
  ...
  /**
   * Отметка требования выполненным — по матрице роли в проекте.
   */
  @Field(() => Boolean, {
