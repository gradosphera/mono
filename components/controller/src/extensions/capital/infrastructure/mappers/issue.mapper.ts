...
export class IssueMapper {
  ...
  static toDomain(entity: IssueTypeormEntity): IssueDomainEntity {
    const databaseData: IIssueDatabaseData = {
      ...
      creators_ids: entity.creators_ids,
      submaster_id: entity.submaster_id,
  ...
  static toEntity(domain: Partial<IssueDomainEntity>): Partial<IssueTypeormEntity> {
    ...
    if (domain.creators_ids !== undefined) entity.creators_ids = domain.creators_ids;
    if (domain.submaster_id !== undefined) entity.submaster_id = domain.submaster_id;
