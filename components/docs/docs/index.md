...
Платформа - это программное обеспечение, которые объединяет подсети, кооперативы и их пайщиков по общему признаку целевой потребительской программы и/или локации. Они организуют и реализуют надсистемные процессы и правила кооперации с учетом региональных особенностей и собственных целей. 

Так, платформа «Соседи» объединяет пайщиков России и Беларуси на столе заказов. А платформа "Мусульманский кошелек" объединяет пайщиков всех кооперативов всех подсетей в одном интерфейсе для халяльных инвестиций по нормам шариата. 

Платформы по организационно-правовой форме являются потребительскими кооперативами и обеспечивают среду взаимного членства в своём правовом поле. Платформы обеспечивают интернациональные коммуникационные связи между подсетями и странами, являются шлюзами для передачи информации/имущества. 

С помощью платформ и на основе общих стандартов, становятся возможным создавать кооперативные цепочки удовлетворения потребностей большой длины, когда потребности пайщиков кооперативов удовлетворяются нелинейно через организацию живой, саморазвивающейся сети взаимопомощи, где целое становится больше суммы своих частей.

## Про что документация

Данная документация описывает программный комплекс платформы "Цифровой Кооператив" и приложения, которые поставляются в рамках этой платформы. На основе предоставленной информации пайщики узнают как использовать цифровой кооператив, председатели и члены советов - как управлять им, а разработчики - как создавать для него новые приложения или использовать существующие возможности для создания новых платформ на его основе. 
...
На многих страницах с бизнес-описанием внизу добавлен свёрнутый блок **«Техническая информация для разработчика»**: в нём перечислены соответствующие поля GraphQL (`Query` / `Mutation`) и пространства имён `@coopenomics/sdk`, не смешиваясь с текстом для председателя, совета или пайщика. Раскрывайте блок только при работе с API или интеграцией.