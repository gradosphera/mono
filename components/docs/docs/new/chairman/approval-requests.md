...
Запросы одобрений являются частью бизнес-процессов, по ходу которых они запрашиваются. Как только одобрение председателя будет получено - процесс продолжит выполняться по кодексу смарт-контрактов. 
