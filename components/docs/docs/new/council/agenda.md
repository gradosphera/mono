...
Если утверждается стандартизированное решение, то оно автоматически в этот же момент и исполняется на уровне кодекса смарт-контрактов. Произвольные решения, как было отмечено ранее, автоматически не исполняются, а только фиксируются в реестре документов. 
