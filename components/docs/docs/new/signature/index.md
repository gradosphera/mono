...
Подписать можно строку, файл или их контрольную сумму. В ЦК, согласно кодексу, мы извлекаем контрольную сумму бинарных данных PDF документа по алгоритму sha256. Полученную строку длиной 64 символа мы подписываем, используя специализированный внутренний формат хранения подписи в документах.
