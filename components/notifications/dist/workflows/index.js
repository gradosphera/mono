...
exports.workflowsById = exports.allWorkflows = void 0;
...
exports.allWorkflows = [
    welcome_1.welcomeWorkflow,
    // Здесь будут добавляться новые воркфлоу
];
// Экспортируем воркфлоу по ID для удобного доступа
exports.workflowsById = exports.allWorkflows.reduce((acc, workflow) => {
