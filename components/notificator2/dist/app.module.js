...
const web_push_module_1 = require("./modules/web-push.module");
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    database: configService.get('DB_DATABASE', 'notificator'),
                    entities: [push_subscription_entity_1.PushSubscription],
