...
/** Удалить аккаунт пайщика из системы учёта провайдера. Только для незавершённых регистрационных статусов; активный/заблокированный/зарегистрированный в блокчейне удалить нельзя. */
