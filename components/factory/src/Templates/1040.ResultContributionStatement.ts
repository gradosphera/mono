...
export const Schema: JSONSchemaType<Model> = {
  ...
  required: ['meta', 'coop', 'vars', 'common_user', 'contributor_hash', 'contributor_short_hash', 'contributor_created_at', 'blagorost_agreement_hash', 'blagorost_agreement_short_hash', 'blagorost_agreement_created_at', 'project_name', 'component_name', 'result_hash', 'result_short_hash', 'percent_of_result', 'total_amount'],
