...
export const Schema: JSONSchemaType<Model> = {
  ...
  required: ['meta', 'coop', 'vars', 'decision', 'common_user', 'contributor_hash', 'contributor_short_hash', 'contributor_created_at', 'blagorost_agreement_hash', 'blagorost_agreement_short_hash', 'blagorost_agreement_created_at', 'result_act_hash', 'result_act_short_hash', 'result_hash', 'percent_of_result', 'total_amount'],
